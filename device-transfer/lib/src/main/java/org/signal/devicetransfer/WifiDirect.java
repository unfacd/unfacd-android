...
public final class WifiDirect {
  ...
  private static final String  SERVICE_INSTANCE_TEMPLATE = "_devicetransfer" + EXTRA_INFO_PLACEHOLDER + "._unfacd.io";//AA+
  private static final Pattern SERVICE_INSTANCE_PATTERN  = Pattern.compile("_devicetransfer(\\._(.+))?\\._unfacd\\.io");
  ...
  synchronized void initialize(@NonNull WifiDirectConnectionListener connectionListener) throws WifiDirectUnavailableException {
    ...
    ContextCompat.registerReceiver(context, wifiDirectCallbacks, intentFilter, ContextCompat.RECEIVER_EXPORTED);
  }
