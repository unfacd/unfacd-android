...
public class MapableAvatarDownloadJob extends BaseJob {
  ...
  private static final String TAG = MapableAvatarDownloadJob.class.getSimpleName();
  ...
  public void onRun() throws IOException {
    ...
    SignalServiceAttachmentPointer  avatarPointer      = new SignalServiceAttachmentPointer(fenceRecord.getAvatar().getId(),
                                                                 ...
                                                                 fenceRecord.getAvatar().hasFileName()? Optional.of(fenceRecord.getAvatar().getFileName()):Optional.absent(), false);
