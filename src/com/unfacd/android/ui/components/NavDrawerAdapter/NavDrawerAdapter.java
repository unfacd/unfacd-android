package com.unfacd.android.ui.components.NavDrawerAdapter;
...
public class NavDrawerAdapter extends BaseAdapter {
  ...
  public View getView(int position, View convertView, ViewGroup parent) {
    ...
    if (convertView == null) {
      vi = inflater.inflate(R.layout.uf_navdrawer_list_item, null);
    ...
    if (labels.length <= 0) {
      ...
      if (holder.text != null) {
        ...
        if (position == menu_privacy_hide) {
          if (true){ //if (new GDataPreferences(activity).isPrivacyActivated()) {
