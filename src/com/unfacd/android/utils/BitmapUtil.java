...
public class BitmapUtil {
  ...
  public static byte[] createScaledBytes(Context context, Uri uri, int maxWidth, int maxHeight, int maxSize)
  ...
  public static Bitmap createScaledBitmap(Context context, Uri uri, int maxWidth, int maxHeight)
  ...
  private static Bitmap createScaledBitmap(Context context,  Uri uri, int maxWidth, int maxHeight, boolean constrainedMemory)
          throws IOException, BitmapDecodingException
  {
    ...
    return createScaledBitmap(is,
            PartAuthority.getAttachmentStream(context, uri),
            PartAuthority.getAttachmentStream(context, uri),
