...
public class IntentServiceSearchFences extends IntentService {
  ...
  private static final String TAG = IntentServiceGetFencesNearBy.class.getSimpleName();
  ...
  protected void onHandleIntent(Intent intent) {
    ...
    try {
      try {
        socket = new PushServiceSocket(networkAccess.getConfiguration(ApplicationContext.getInstance()),
