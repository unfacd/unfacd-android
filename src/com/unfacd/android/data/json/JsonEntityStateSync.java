...
public class JsonEntityStateSync
{
  ...
  @JsonProperty
  private List<JsonEntityFence> fences;

  @JsonProperty
  private List<JsonEntityFence> fences_invited;
  ...
  public List<JsonEntityFence> getFences ()
  {
    return fences;
  }

  public List<JsonEntityFence> getFencesInvited ()
  {
