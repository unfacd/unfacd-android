...
public class SignalServiceNetworkAccess {
  ...
  public SignalServiceNetworkAccess(Context context) {
    ...
    // ufsrv urls
    this.uncensoredConfiguration = new SignalServiceConfiguration(new SignalServiceUrl[] {new SignalServiceUrl(BuildConfig.UFSRVAPI_URL, new SignalServiceTrustStore(context))},
                                                                  new SignalCdnUrl[] {new SignalCdnUrl(BuildConfig.UFSRVMEDIA_URL, new SignalServiceTrustStore(context))},
