...
public class DatabaseAttachment extends Attachment {
  ...
  public DatabaseAttachment(AttachmentId attachmentId, long mmsId,  boolean hasData,
                            boolean hasThumbnail, String contentType, int transferProgress, long size,
  ...
  public DatabaseAttachment(AttachmentId attachmentId, long mmsId,  boolean hasData,
                            ...
                            String ufId)
  {
    super(contentType, transferProgress, size, fileName, location, key, relay, digest, fastPreflightId, voiceNote, width, height, quote, caption, stickerLocator, ufId);
    this.attachmentId = attachmentId;
    this.hasData      = hasData;
    this.hasThumbnail = hasThumbnail;
    this.mmsId        = mmsId;
