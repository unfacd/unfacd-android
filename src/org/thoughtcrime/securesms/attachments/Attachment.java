...
//  ufId as opposed to Long-type id used by orig signal
public abstract class Attachment {
                    ...
                    int width, int height, boolean quote, @Nullable String caption, @Nullable StickerLocator stickerLocator)
  {
    ...
    //
    this.ufId= UfsrvUid.UndefinedUfsrvUid;
    //
  }
                    ...
                    String ufId)
  {
    ...
    //
    if (TextUtils.isEmpty(ufId))  this.ufId=UfsrvUid.UndefinedUfsrvUid;
    else                          this.ufId=ufId;
    //Log.d("Attachment", String.format("Attachment: Constructor: ufId:'%s'", this.ufId));
  }
  //
