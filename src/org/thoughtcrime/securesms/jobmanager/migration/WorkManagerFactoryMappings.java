...
public class WorkManagerFactoryMappings {
  ...
  private static final Map<String, String> FACTORY_MAP = new HashMap<String, String>() {{
    ...
    //
    put(LocationRefreshJob.class.getName(), LocationRefreshJob.KEY);
    put(MapableAvatarDownloadJob.class.getName(), MapableAvatarDownloadJob.KEY);
    put(MessageCommandEndSessionJob.class.getName(), MessageCommandEndSessionJob.KEY);
    put(PresenceReceiverJob.class.getName(), PresenceReceiverJob.KEY);
    put(ProfileAvatarDownloadJob.class.getName(), ProfileAvatarDownloadJob.KEY);
    put(RegistrationStatusVerifierJob.class.getName(), RegistrationStatusVerifierJob.KEY);
    put(ReloadGroupJob.class.getName(), ReloadGroupJob.KEY);
    put(ResetGroupsJob.class.getName(), ResetGroupsJob.KEY);
    put(UfsrvUserCommandProfileJob.class.getName(), UfsrvUserCommandProfileJob.KEY);
    put(UnfacdIntroContactJob.class.getName(), UnfacdIntroContactJob.KEY);
