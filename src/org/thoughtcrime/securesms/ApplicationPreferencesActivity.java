...
import com.unfacd.android.preferences.GroupsPreferenceFragment;
    ...
    implements SharedPreferences.OnSharedPreferenceChangeListener
{
  ...
  //
  private static final String PREFERENCE_CATEGORY_GROUPS         = "preference_category_groups";
  //
  ...
  protected void onCreate(Bundle icicle, boolean ready) {
    ...
    if (getIntent() != null && getIntent().getCategories() != null && getIntent().getCategories().contains("android.intent.category.NOTIFICATION_PREFERENCES")) {
      ...
      initFragment(R.id.container, new ApplicationPreferenceFragment());
    }
  }
...
//        .setOnPreferenceClickListener(new CategoryClickListener(PREFERENCE_CATEGORY_SMS_MMS));
      ...
      //
      this.findPreference(PREFERENCE_CATEGORY_GROUPS)
              .setOnPreferenceClickListener(new CategoryClickListener(PREFERENCE_CATEGORY_GROUPS));
      //
...
//          .setSummary(SmsMmsPreferenceFragment.getSummary(getActivity()));
      ...
      // summary subtitle
      this.findPreference(PREFERENCE_CATEGORY_GROUPS)
              .setSummary(GroupsPreferenceFragment.getSummary(getActivity()));
      //
    }

    @TargetApi(11)
    private void tintIcons(Context context) {
//      Drawable sms           = DrawableCompat.wrap(ContextCompat.getDrawable(context, R.drawable.ic_textsms_grey_32dp));//-
      Drawable notifications = DrawableCompat.wrap(ContextCompat.getDrawable(context, R.drawable.ic_notifications_none_white_36dp));
      Drawable privacy       = DrawableCompat.wrap(ContextCompat.getDrawable(context, R.drawable.ic_screen_lock_portrait_white_36dp));
      Drawable appearance    = DrawableCompat.wrap(ContextCompat.getDrawable(context, R.drawable.ic_face_white_36dp));
      Drawable chats         = DrawableCompat.wrap(ContextCompat.getDrawable(context, R.drawable.ic_forum_grey_32dp));
//      Drawable devices       = DrawableCompat.wrap(ContextCompat.getDrawable(context, R.drawable.ic_laptop_white_24dp));//-
      Drawable advanced      = DrawableCompat.wrap(ContextCompat.getDrawable(context, R.drawable.ic_fitness_center_white_36dp));
      Drawable groups        = DrawableCompat.wrap(ContextCompat.getDrawable(context, R.drawable.ic_people_outline_white_36dp));
...
//      DrawableCompat.setTint(devices, color);//-
      ...
      DrawableCompat.setTint(groups, color);
...
//      this.findPreference(PREFERENCE_CATEGORY_DEVICES).setIcon(devices);//-
      ...
      this.findPreference(PREFERENCE_CATEGORY_GROUPS).setIcon(advanced);
    }
    ...
    private class CategoryClickListener implements Preference.OnPreferenceClickListener {
      ...
      public boolean onPreferenceClick(Preference preference) {
        ...
        case PREFERENCE_CATEGORY_ADVANCED:
          ...
          break;
        //
        case PREFERENCE_CATEGORY_GROUPS:
          fragment = new GroupsPreferenceFragment();
          break;
        //
        default:
