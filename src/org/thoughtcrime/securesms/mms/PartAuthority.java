...
public class PartAuthority {
  ...
  private static final String PART_URI_STRING   = "content://com.unfacd.uf/part"; //
  private static final String THUMB_URI_STRING  = "content://com.unfacd.uf/thumb";
  private static final String STICKER_URI_STRING  = "content://com.unfacd.uf/sticker";
  ...
  static {
    ...
    uriMatcher.addURI("com.unfacd.uf", "part/*/*/#", PART_ROW);//
    uriMatcher.addURI("com.unfacd.uf", "thumb/*/*/#", THUMB_ROW); //
    uriMatcher.addURI("com.unfacd.uf", "sticker/#", STICKER_ROW);
  ...
  public static Uri getAttachmentDataUri(AttachmentId attachmentId) {
    ...
    Uri uri = Uri.withAppendedPath(PART_CONTENT_URI, String.valueOf(attachmentId.getUniqueId())+"/"+attachmentId.getUfId());//
  ...
  public static Uri getAttachmentThumbnailUri(AttachmentId attachmentId) {
    ...
    Uri uri = Uri.withAppendedPath(THUMB_CONTENT_URI, String.valueOf(attachmentId.getUniqueId())+"/"+attachmentId.getUfId());//
    return ContentUris.withAppendedId(uri, attachmentId.getRowId());
  }
