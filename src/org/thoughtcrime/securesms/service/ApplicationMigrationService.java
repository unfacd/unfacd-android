...
public  static final String MIGRATE_DATABASE    = "com.unfacd.android.ApplicationMigration.MIGRATE_DATABSE";//
  ...
  private class ImportRunnable implements Runnable {
    ...
    public void run() {
      ...
      WakeLock     wakeLock     = powerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "unfacd:migration");//
