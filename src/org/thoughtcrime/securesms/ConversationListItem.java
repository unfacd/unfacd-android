        ...
        BindableConversationListItem, Unbindable
{
                   ...
                   @Nullable String highlightSubstring)
  {
    ...
    if (recipient.getAddress().isGroup()) {
      ...
      groupRecord = DatabaseFactory.getGroupDatabase(getContext())
              .getGroup(recipient.getAddress().toGroupString()).orNull();
                   ...
                   @Nullable String        highlightSubstring)
  {
    ...
    groupRecord= DatabaseFactory.getGroupDatabase(getContext())
            .getGroup(recipient.getAddress().serialize()).orNull();
