...
public class ContactRepository {
  ...
  private @Nullable Contact getContactFromSystemContacts(long contactId) {
    ...
    UfsrvUid    ufsrvUid     = getUfsrvUidInfo (contactId, phoneNumbers);//

    return new Contact(name, null, phoneNumbers, getEmails(contactId), getPostalAddresses(contactId), avatar, ufsrvUid.getUfsrvUidEncoded());
  }
  ...
  private @Nullable Contact getContactFromVcard(@NonNull Uri uri) {
    ...
    try (InputStream stream = PartAuthority.getAttachmentStream(context, uri)) {
      ...
      contact = new Contact(name, organization, phoneNumbers, emails, postalAddresses, null, null);//
    } catch (IOException e) {
