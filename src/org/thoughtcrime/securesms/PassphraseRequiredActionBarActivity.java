...
import com.unfacd.android.ui.IntroActivity;
...
public abstract class PassphraseRequiredActionBarActivity extends BaseActionBarActivity implements MasterSecretListener {
  ...
  // intro screen
  private static final int STATE_INTRO_SCREEN             = 10;
  //
  ...
  protected void onResume() {
    ...
    if (!TextUtils.isEmpty(TextSecurePreferences.getUfsrvCookie(this))) {
      Log.d(TAG, ">>> onResume(): COOKIE SET -> INITIATING MessageRetrievalService");
      ...
      Log.d(TAG, ">>> onResume(): NO COOKIE -> NOT INITIATING MessageRetrievalService");
    }
    //
  }
  ...
  //
  public void onEvent (SignalServiceMessagePipe pipe)
  {
    Log.d(TAG, ">>> onEvent: RECEIVED STICKY PIPE REFERENCE....");
    this.pipe=pipe;
  }
  ...
  private int getApplicationState(boolean locked) {
    ...
    } else if (TextUtils.isEmpty(TextSecurePreferences.getUfsrvUserId(this))||!TextSecurePreferences.getUfsrvUfAccountCreated(this)) {//
  ...
  // intro screen support
  private Intent getIntroScreenIntent() {
    return getRoutedIntent(IntroActivity.class, getConversationListIntent());
  }
  //
