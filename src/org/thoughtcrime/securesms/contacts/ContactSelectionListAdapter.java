                                                    ...
                                                    StickyHeaderAdapter<HeaderViewHolder>
{
  ...
  //
  private HashMap<String, Recipient> recipientsPreExisting;
  //
  ...
  public ContactSelectionListAdapter(@NonNull  Context context,
                                     ...
                                     boolean multiSelect,
                                     HashMap<String, Recipient> recipientsPreExisting)
  {
    ...
    this.recipientsPreExisting  = recipientsPreExisting;//
  }
  ...
  public void onBindItemViewHolder(ViewHolder viewHolder, @NonNull Cursor cursor) {
    ...
    viewHolder.setChecked(selectedContacts.contains(address.toString()));// replaced number with address
  }
