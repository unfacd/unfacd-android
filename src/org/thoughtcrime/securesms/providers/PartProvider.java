...
public class PartProvider extends ContentProvider {
  ...
  private static final String CONTENT_URI_STRING = "content://com.unfacd.provider.securesms/part";//
  ...
  static {
    ...
    uriMatcher.addURI("com.unfacd.provider.securesms", "part/*/#", SINGLE_ROW);//
  }
