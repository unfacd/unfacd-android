        ...
        ConversationStickerSuggestionAdapter.EventListener
{
  ...
  private View          audioVideoCallToggle; //A+
  ...
  public void onFinishInflate() {
    ...
    // enabled the mic
    microphoneRecorderView.setVisibility(View.VISIBLE);
    microphoneRecorderView.setClickable(true);
  ...
  public void onRecordPressed() {
    ...
    ViewUtil.fadeOut(audioVideoCallToggle, FADE_TIME, View.INVISIBLE);//
  }
  ...
  public void setEnabled(boolean enabled) {
    ...
    audioVideoCallToggle.setEnabled(enabled);//
  }
  ...
  private long onRecordHideEvent() {
    ...
    future.addListener(new AssertedSuccessListener<Void>() {
      ...
      public void onSuccess(Void result) {
        ...
        ViewUtil.fadeIn(audioVideoCallToggle, FADE_TIME);//
        buttonToggle.animate().alpha(1).setDuration(FADE_TIME).start();
      }
    });
