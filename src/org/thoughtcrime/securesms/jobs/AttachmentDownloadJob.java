...
public class AttachmentDownloadJob extends BaseJob {
  ...
  private static final String KEY_UFSRV_ID      = "ufsrv_id";//
  ...
  public @NonNull Data serialize() {
    return new Data.Builder().putLong(KEY_MESSAGE_ID, messageId)
            ...
            .putString(KEY_UFSRV_ID, ufsrvId) //
            .build();
  }
  ...
  public void onAdded() {
    ...
    final AttachmentId       attachmentId = new AttachmentId(partRowId, partUniqueId, ufsrvId); // ufsrvid
  ...
  public void doWork() throws IOException {
    ...
    final AttachmentDatabase database     = DatabaseFactory.getAttachmentDatabase(context);
    final AttachmentId       attachmentId = new AttachmentId(partRowId, partUniqueId, ufsrvId);// ufId
    final DatabaseAttachment attachment   = database.getAttachment(attachmentId);
  ...
  public void onCanceled() {
    ...
    final AttachmentId attachmentId = new AttachmentId(partRowId, partUniqueId, ufsrvId);//
      ...
      throws InvalidPartException
  {
    ...
    try {
      ...
      return new SignalServiceAttachmentPointer(attachment.getUfId(), id, null, key,
  ...
  public static final class Factory implements Job.Factory<AttachmentDownloadJob> {
    ...
    public @NonNull AttachmentDownloadJob create(@NonNull Parameters parameters, @NonNull Data data) {
      return new AttachmentDownloadJob(parameters,
                                       ...
                                       new AttachmentId(data.getLong(KEY_PART_ROW_ID), data.getLong(KEY_PAR_UNIQUE_ID), data.getString(KEY_UFSRV_ID)),// ufsrvid
