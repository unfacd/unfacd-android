...
public class SmsMessageRecord extends MessageRecord {
  ...
  public SmsMessageRecord(long id,
                          ...
                          int subscriptionId, long expiresIn, long expireStarted, int readReceiptCount, boolean unidentified,
  ...
  public SpannableString getDisplayBody(@NonNull Context context) {
    if (SmsDatabase.Types.isFailedDecryptType(type)) {
      return new SpannableString(context.getString(R.string.MessageDisplayHelper_bad_encrypted_message));
      ...
      return new SpannableString(context.getString(R.string.SmsMessageRecord_secure_session_reset_s, recipientOriginator.getDisplayName()));//
//      return new SpannableString(context.getString(R.string.SmsMessageRecord_secure_session_reset_s, getIndividualRecipient().toShortString()));
