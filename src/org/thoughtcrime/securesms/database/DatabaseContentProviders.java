...
public class DatabaseContentProviders {
  ...
  public static class ConversationList extends NoopContentProvider {
    public static final Uri CONTENT_URI = Uri.parse("content://com.unfacd.database.conversationlist"); //
  }

  public static class Conversation extends NoopContentProvider {
    private static final String CONTENT_URI_STRING = "content://com.unfacd.database.conversation/";
  ...
  public static class Attachment extends NoopContentProvider {
    public static final Uri CONTENT_URI = Uri.parse("content://com.unfacd.database.attachment");
  }

  //
  public static class Identity extends NoopContentProvider {
    public static final Uri CONTENT_URI = Uri.parse("content://com.unfacd.database.identity");
  }//

  public static class Sticker extends NoopContentProvider {
    public static final Uri CONTENT_URI = Uri.parse("content://com.unfacd.database.sticker");
  }

  public static class StickerPack extends NoopContentProvider {
    public static final Uri CONTENT_URI = Uri.parse("content://com.unfacd.database.stickerpack");
  }
