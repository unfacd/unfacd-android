...
public abstract class MessagingDatabase extends Database implements MmsSmsColumns {
  ...
  public static class SyncMessageId {
    ...
    //
    public SyncMessageId(Address address, long timetamp, String ufsrvuid, long fid, long eid) {
      this.address  = address;
      this.timetamp = timetamp;
    ...
    public UfsrvMessageUtils.UfsrvMessageIdentifier getUfsrvMessageIdentifier () {
      return new UfsrvMessageUtils.UfsrvMessageIdentifier(ufsrvuid, fid, eid, timetamp);
    }
//
