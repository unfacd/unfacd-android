...
public class DatabaseFactory {
  ...
  private final UnfacdIntroContactsDatabase unfacdIntroContactsDatabase;
  ...
  //
  public static UnfacdIntroContactsDatabase getUnfacdIntroContactsDatabase(Context context) {
    return getInstance(context).unfacdIntroContactsDatabase;
  }
  ...
  private DatabaseFactory(@NonNull Context context) {
    ...
    //
    this.unfacdIntroContactsDatabase          = new UnfacdIntroContactsDatabase(context, databaseHelper);
  }
