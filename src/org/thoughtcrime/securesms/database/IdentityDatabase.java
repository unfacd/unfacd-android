...
public class IdentityDatabase extends Database {
  ...
  //
  public static final String IDENTITY_URI      = "content://com.unfacd.database.identity/";// as per DatabaseContentProviders.Identity
...
//    IdentityKey identity            = new IdentityKey(Base64.decode(serializedIdentity), 0);
    ...
    if (serializedIdentity!=null) identity            = new IdentityKey(Base64.decode(serializedIdentity), 0);//
