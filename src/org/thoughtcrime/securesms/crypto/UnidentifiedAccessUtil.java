...
public class UnidentifiedAccessUtil {
  ...
  public static @NonNull byte[] getSelfUnidentifiedAccessKey(@NonNull Context context) {
    byte[] accessTokenRaw = UnidentifiedAccess.deriveAccessKeyFrom(ProfileKeyUtil.getProfileKey(context));
    TextSecurePreferences.setAccessToken(context, Base64.encodeBytes(accessTokenRaw));

    return accessTokenRaw;
  }

  //
  public static void setSelfUnidentifiedAccessKey(@NonNull Context context, @NonNull String accessKeyEncoded) {
    TextSecurePreferences.setAccessToken(context, accessKeyEncoded);
  }
  //
