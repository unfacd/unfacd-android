...
public class MarkReadReceiver extends BroadcastReceiver {
  ...
  public static final  String CLEAR_ACTION          = "com.unfacd.android.notifications.CLEAR";//
  ...
  public static void process(@NonNull Context context, @NonNull List<MarkedMessageInfo> markedReadMessages) {
    ...
    for (Address address : addressMap.keySet()) {
      ...
      // this includes timestamps as well as other message identifiers for this user
      List<UfsrvMessageUtils.UfsrvMessageIdentifier> messageIdentifiers = Stream.of(addressMap.get(address)).map(SyncMessageId::getUfsrvMessageIdentifier).toList();

      ApplicationContext.getInstance(context)
              .getJobManager()
              .add(new SendReadReceiptJob(address, timestamps, messageIdentifiers));// last arg
    }
  }
