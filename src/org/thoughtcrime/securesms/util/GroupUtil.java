...
public class GroupUtil {
  ...
  public static final String ENCODED_GROUP_PREFIX         = "__unfacd_group__!";
  private static final String ENCODED_MMS_GROUP_PREFIX    = "__unfacd_mms_group__!";//
  private static final String TAG                         = GroupUtil.class.getSimpleName();

  public static String getEncodedId(byte[] groupId, boolean mms) {
    return (mms ? ENCODED_MMS_GROUP_PREFIX : ENCODED_GROUP_PREFIX) + Hex.toStringCondensed(groupId);//
  }
  ...
  public static boolean isEncodedGroup(@NonNull String groupId) {
    return groupId.startsWith(ENCODED_GROUP_PREFIX) || groupId.startsWith(ENCODED_MMS_GROUP_PREFIX);
  }
  ...
  public static Optional<OutgoingGroupMediaMessage> createGroupLeaveMessage(@NonNull Context context, @NonNull Recipient groupRecipient) {
    ...
    GroupDatabase.GroupRecord groupRecord=DatabaseFactory.getGroupDatabase(context).getGroupByGroupId(encodedGroupId);
    SignalServiceProtos.FenceCommand fenceCommand=MessageSender.buildFenceCommandFinal(ApplicationContext.getInstance(),
                                                                                       ...
                                                                                       Optional.absent(),
                                                                                       new  UfsrvCommandUtils.CommandArgDescriptor(SignalServiceProtos.FenceCommand.CommandTypes.LEAVE_VALUE, 0),
                                                                                       Optional.absent(),
                                                                                       Optional.absent(),
                                                                                       timeSentInMillis);
