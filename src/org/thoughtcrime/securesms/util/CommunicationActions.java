...
public class CommunicationActions {
  ...
  public static void startVoiceCall(@NonNull Activity activity, @NonNull Recipient recipient, @NonNull Long fid) { // fid
    ...
    Permissions.with(activity)
            ...
            .onAllGranted(() -> {
              ...
              intent.putExtra(WebRtcCallService.EXTRA_FID, fid);//
              activity.startService(intent);

              Intent activityIntent = new Intent(activity, WebRtcCallActivity.class);
              activityIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
              activityIntent.putExtra(WebRtcCallService.EXTRA_FID, fid);//
