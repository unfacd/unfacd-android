        ...
        implements RecipientModifiedListener, BindableConversationItem
{
  ...
  private void bind(@NonNull MessageRecord messageRecord, @NonNull Locale locale) {
    ...
    else if (messageRecord.isProfileLog() || messageRecord.isGroupProfileLog())            setProfileRecord(messageRecord); //
  ...
  //
  private void setProfileRecord(MessageRecord messageRecord) {
    icon.setImageResource(R.drawable.ic_face_white_24dp);
    icon.clearColorFilter();
    icon.setColorFilter(getContext().getResources().getColor(R.color.grey_600));//todo: get the right icon instead of programatic colouring
