...
public class GiphyGifLoader extends GiphyLoader {
  ...
  protected String getTrendingUrl() {
    return "https://api.giphy.com/v1/gifs/trending?api_key=miDF9xez7bY3ljCXQ2HcIRaPMSIGJxgt&offset=%d&limit=" + PAGE_SIZE;
    //return "https://api.giphy.com/v1/gifs/trending?api_key=3o6ZsYH6U6Eri53TXy&offset=%d&limit=" + PAGE_SIZE;
  }

  @Override
  protected String getSearchUrl() {
    return "https://api.giphy.com/v1/gifs/search?api_key=miDF9xez7bY3ljCXQ2HcIRaPMSIGJxgt&offset=%d&limit=" + PAGE_SIZE + "&q=%s";
