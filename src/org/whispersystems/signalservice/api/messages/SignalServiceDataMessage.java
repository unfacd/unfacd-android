...
public class SignalServiceDataMessage {
  ...
  private final Optional<SignalServiceGroup>            group;// this one already include FenceCommand
  ...
  //
  private Optional<SignalServiceProtos.UfsrvCommandWire>    ufsrvCommand;
  //
  ...
  public SignalServiceDataMessage(long timestamp, SignalServiceGroup group, List<SignalServiceAttachment> attachments, String body, int expiresInSeconds) {
    this(timestamp, group, attachments, body, false, expiresInSeconds, false, null, false, null, null, null, null, 0, Optional.absent()); // optional ufsrv
  }
                                  ...
                                  int messageTimerInSeconds)
  {
    ...
    //
    this.ufsrvCommand=Optional.absent();
    //
  }



  //  ufsrv specific types, based on above.
  //todo: this should replace the one above with exposed ufsrv types. one type only is required
  public SignalServiceDataMessage(long timestamp, SignalServiceGroup group,
                                  List<SignalServiceAttachment> attachments,
                                  String body, boolean endSession, int expiresInSeconds,
                                  boolean expirationUpdate,  byte[] profileKey, boolean profileKeyUpdate, Quote quote, List<SharedContact> sharedContacts, List<Preview> previews,
                                  Sticker sticker,
                                  int messageTimerInSeconds,
  ...
  public static class Builder {
    ...
    public SignalServiceDataMessage build() {
      ...
      return new SignalServiceDataMessage(timestamp, group, attachments, body, endSession,
                                          ...
                                          Optional.fromNullable(ufsrvCommand));// ufsrv
    }
  }
