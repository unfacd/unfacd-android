        ...
        EmojiPageViewGridAdapter.VariationSelectorListener
{
  ...
  private static final String ARG_FID        = "arg_is_fid";//AA+
  ...
  public static DialogFragment createForMessageRecord(@NonNull MessageRecord messageRecord, int startingPage) {
    ...
    args.putLong(ARG_FID, messageRecord.getUfsrvFid());//AA+
    fragment.setArguments(args);
  ...
  private void initializeViewModel() {
    ...
    ReactWithAnyEmojiViewModel.Factory factory    = new ReactWithAnyEmojiViewModel.Factory(repository, args.getLong(ARG_MESSAGE_ID), args.getBoolean(ARG_IS_MMS), args.getLong(ARG_FID));//AA+
