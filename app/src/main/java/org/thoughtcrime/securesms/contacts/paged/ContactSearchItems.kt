...
object ContactSearchItems {
   ...
   */
  private abstract class BaseRecipientViewHolder<T: MappingModel<T>, D : ContactSearchData>(itemView: View, val onClick: (D, Boolean) -> Unit) : MappingViewHolder<T>(itemView) {
