...
public class ProfileContactPhoto implements ContactPhoto {
  ...
  public ProfileContactPhoto(@NonNull Recipient recipient, @Nullable String avatarObject) {
    if (recipient == null) this.recipient = Recipient.UNKNOWN; //AA++
...
//    File avatarFile = AvatarHelper.getAvatarFile(context, Address.fromSerialized(recipient.getGroupAvatarUfsrvId()));//AA++
