...
//AA this has been converted to hosting activity + fragment: PlacePickerHostActivity
...
public final class PlacePickerActivity extends AppCompatActivity {
  ...
  private static final String ADDRESS_INTENT = "ADDRESS"; //AA result return intent
  ...
  public void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    Location seedLocation = intent.getParcelableExtra(SEED_LOCATION_INTENT);
    if (seedLocation != null) seededLocation = new LatLng(seedLocation.getLatitude(), seedLocation.getLongitude());
    isHomebaseGeolocPicker = intent.getBooleanExtra(SELECTION_MODE_INTENT, false);
    //
