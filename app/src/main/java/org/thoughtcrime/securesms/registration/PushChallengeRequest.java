...
public final class PushChallengeRequest {
                                                          ...
                                                          @NonNull String email)
  {
    ...
    Request request = new Request(accountManager, fcmToken.get(), email, timeoutMs);//AA+ email
  ...
  public static void postChallengeResponse(@NonNull String challenge) {//AA for ufsrv this is the rego email
  ...
  public static class Request {
    ...
    private Optional<String> requestAndReceiveChallengeBlocking() {
      ...
      try {
        ...
        latch.await(timeoutMs, TimeUnit.MILLISECONDS);//AA wait for google's GCM async response
