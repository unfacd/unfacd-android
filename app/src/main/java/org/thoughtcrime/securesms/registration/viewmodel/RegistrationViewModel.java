    ...
    return super.requestVerificationCode(mode)
                .doOnSuccess(processor -> {
                  if (processor.hasResult()) {
                    ...
                    setRegoCookie(processor.getResult().getCookie());//AA+
                    TextSecurePreferences.setUfsrvPendingCookie(ApplicationDependencies.getApplication(), processor.getResult().getCookie());//AA+
                  }
                });
  }
