...
import com.unfacd.android.ui.SpruikPager;
...
public final class WelcomeFragment extends LoggingFragment {
  ...
  private static final String[] PERMISSIONS        = { Manifest.permission.WRITE_CONTACTS,
                                                       ...
                                                       Manifest.permission.READ_MEDIA_IMAGES, Manifest.permission.READ_MEDIA_VIDEO, //AA+ PermissionCompat.forImagesAndVideos(),
                                                       Manifest.permission.READ_PHONE_STATE,
                                                       Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION};//AA+};
  @RequiresApi(26)
  ...
  private static final            int[] HEADERS          = { R.drawable.ic_contacts_white_48dp, R.drawable.ic_folder_white_48dp, R.drawable.ic_explore_white_48dp };//AA+
  private static final            int[] HEADERS_API_29   = { R.drawable.ic_contacts_white_48dp, R.drawable.ic_explore_white_48dp };//AA+

  private CircularProgressButton continueButton;
  private RegistrationViewModel  viewModel;

  private SpruikPager spruikPager;//AA+
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    ...
    if (viewModel.isReregister()) {
      ...
      //AA+
      spruikPager = view.findViewById(R.id.unfacd_spruik_pager);
      //
