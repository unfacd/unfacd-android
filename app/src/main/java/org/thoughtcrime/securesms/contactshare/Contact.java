...
public class Contact implements Parcelable {
  ...
  public Contact(@JsonProperty("name")            @NonNull  Name                name,
                 ...
                 @JsonProperty("ufsrvUid")        @Nullable String              ufsrvUid)
  {
    this.name            = name;
  ...
  //AA+
  public @Nullable String getUfsrvUid () {
    return ufsrvUid;
  }
