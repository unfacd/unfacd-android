...
//AA+ ListSummaryPreferenceFragment
public class TBDAppProtectionPreferenceFragment /*extends ListSummaryPreferenceFragment */{
 ...
 /* private static final String TAG = Log.tag(AppProtectionPreferenceFragment.class);
  ...
  private void initializeVisibility() {
    ...
    if (preferenceCategory != null) preferenceCategory.setVisible(false);
    //
  }
