...
public class PniAccountInitializationMigrationJob extends MigrationJob {
  ...
  public void performMigration() throws IOException {
    ...
    if (!metadataStore.isSignedPreKeyRegistered()) {
      Log.i(TAG, "!! NOT Uploading signed prekey for PNI.");
...
//      accountManager.setPreKeys(ServiceIdType.PNI, protocolStore.getIdentityKeyPair().getPublicKey(), signedPreKey, oneTimePreKeys);//AA-
