...
public final class SettingsValues extends SignalStoreValues {
  ...
  //AA+
  public static final String GEOGROUPS_ROAMING_MODE                  = "settings.groups.geogroup.roaming.mode";
  public static final String GEOGROUPS_GEOLOC_TRIGGER                = "settings.groups.geogroup.geoloc.trigger";
  public static final String GEOGROUPS_BASELOC_ZONE                  = "settings.groups.geogroup.baseloc.zone";
  public static final String GEOGROUPS_BASELOC_HOME_ADDRESS          = "settings.groups.geogroup.baseloc.home.address";
  public static final String GEOGROUPS_BASELOC_HOME_LATLONG          = "settings.groups.geogroup.baseloc.home.latlong";
  ...
  @NonNull List<String> getKeysToIncludeInBackup() {
    return Arrays.asList(LINK_PREVIEWS,
                         ...
                         SENT_MEDIA_QUALITY,
                         GEOGROUPS_ROAMING_MODE,//AA+
                         GEOGROUPS_GEOLOC_TRIGGER,
                         GEOGROUPS_BASELOC_ZONE  );
  }
  ...
  public boolean isLinkPreviewsEnabled() {
    return getBoolean(LINK_PREVIEWS, true);//AA+ true
  }
  ...
  public Boolean isRoamingEnabled() {
    return getRoamingMode() != UserPrefsUtils.RoamingMode.RM_UNSET;

  }

  public UserPrefsUtils.RoamingMode getRoamingMode() {
    return UserPrefsUtils.RoamingMode.values()[getInteger(GEOGROUPS_ROAMING_MODE, UserPrefsUtils.RoamingMode.RM_UNSET.getValue())];

  }

  public void setRoamingMode(UserPrefsUtils.RoamingMode roamingMode) {
    putInteger(GEOGROUPS_ROAMING_MODE, roamingMode.getValue());

  }

  //get stored value for GEOGROUPS_GEOLOC_TRIGGER
  public UserPrefsUtils.GeolocRoamingTrigger getGeolocRoamingTrigger(){
    return UserPrefsUtils.GeolocRoamingTrigger.values()[getInteger(GEOGROUPS_GEOLOC_TRIGGER, UserPrefsUtils.GeolocRoamingTrigger.NEIGHBOURHOOD.getValue())];
  }

  public void setGeolocRoamingTrigger(UserPrefsUtils.GeolocRoamingTrigger roamingTrigger){
    putInteger(GEOGROUPS_GEOLOC_TRIGGER, roamingTrigger.getValue());
  }

  public UserPrefsUtils.BaselocAnchorZone getBaselocZone(){
    return UserPrefsUtils.BaselocAnchorZone.values()[getInteger(GEOGROUPS_BASELOC_ZONE, UserPrefsUtils.BaselocAnchorZone.COUNTRYHOOD.getValue())];
  }

  public void setBaselocZone(UserPrefsUtils.BaselocAnchorZone baselocZone){
    putInteger(GEOGROUPS_BASELOC_ZONE, baselocZone.getValue());
  }

  /**
   * @return "lat,long"
   */
  public String getHomebaseLocLatLong(){
    return getString(GEOGROUPS_BASELOC_HOME_LATLONG, "");
  }

  /**
   * Should be in "lat,long" format
   */
  public void setHomebaseLocLatLong(String baselocHomeLatLong){
    putString(GEOGROUPS_BASELOC_HOME_LATLONG, baselocHomeLatLong);
  }

  //"country,region,area" No zone information
  public String getHomebaseLocAddress(){
    return getString(GEOGROUPS_BASELOC_HOME_ADDRESS, "");
  }

  public void setHomebaseLocAddress(String baselocHomeAddress){
    putString(GEOGROUPS_BASELOC_HOME_ADDRESS, baselocHomeAddress);
  }
  //
