...
public class NotificationChannels {
  ...
  public static final String INTRO_CONTACTS= "intro_contacts";//AA+
  ...
  private static void onCreate(@NonNull Context context, @NonNull NotificationManager notificationManager) {
    ...
    NotificationChannel introContacts= new NotificationChannel(INTRO_CONTACTS, context.getString(R.string.NotificationChannel_intro_contacts), NotificationManager.IMPORTANCE_LOW);//AA+
    ...
    introContacts.setShowBadge(false);//AA+

    notificationManager.createNotificationChannels(Arrays.asList(messages, calls, failures, backups, lockedStatus, other, voiceNotes, joinEvents, background, callStatus, introContacts));//AA+ intro
