...
data class NotificationConversation(
    ...
    fun getPendingIntent(context: Context): PendingIntent {
        ...
        return TaskStackBuilder.create(context)
                               ...
                               .getPendingIntent(0, PendingIntentFlags.mutable())!!
    }
    ...
    fun getMarkAsReadIntent(context: Context): PendingIntent {
        ...
        return PendingIntent.getBroadcast(context, (threadId * 2).toInt(), intent, PendingIntentFlags.mutable())
    }
    ...
    fun getQuickReplyIntent(context: Context): PendingIntent {
        ...
        return PendingIntent.getActivity(context, (threadId * 2).toInt() + 1, intent, PendingIntentFlags.mutable())
    }
    ...
    fun getRemoteReplyIntent(context: Context, replyMethod: ReplyMethod): PendingIntent {
        ...
        return PendingIntent.getBroadcast(context, (threadId * 2).toInt() + 1, intent, PendingIntentFlags.mutable())
    }
