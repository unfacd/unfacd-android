...
public class RemoteReplyReceiver extends BroadcastReceiver {
  ...
  public static final String REPLY_ACTION       = "com.unfacd.android.notifications.WEAR_REPLY";//AA+
      ...
      SignalExecutors.BOUNDED.execute(() -> {
        ...
        switch (replyMethod) {
          case GroupMessage: {
            ...
            threadId = MessageSender.send(context, reply, -1, false, null, null, UfsrvCommand.TransportType.API_SERVICE, false);
            break;
          }
          case SecureMessage: {
            OutgoingEncryptedMessage reply = new OutgoingEncryptedMessage(recipient, responseText.toString(), expiresIn);
            threadId = MessageSender.send(context, reply, -1, false, null, null, false);
            break;
          }
          case UnsecuredSmsMessage: {
            OutgoingTextMessage reply = new OutgoingTextMessage(recipient, responseText.toString(), expiresIn, subscriptionId);
            threadId = MessageSender.send(context, reply, -1, true, null, null, false);
            break;
          }
          default:
