...
public class OptimizedMessageNotifier implements MessageNotifier {
  ...
  public OptimizedMessageNotifier(@NonNull Application context) {
    this.limiter           = new LeakyBucketLimiter(5, 1000, new Handler(SignalExecutors.getAndStartHandlerThread("unfacd-notifier").getLooper()));//AA+
  ...
  //AA+
  @Override
  public void notifyIntroMessage(@NonNull Context context, long introId) {
    runOnLimiter(() -> getNotifier().notifyIntroMessage(context, introId));
  }
