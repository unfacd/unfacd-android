...
public class TBDApplicationPreferencesActivity /*extends PassphraseRequiredActivity
 ...
 /* public static final String LAUNCH_TO_BACKUPS_FRAGMENT       = "launch.to.backups.fragment";
  ...
  protected void onCreate(Bundle icicle, boolean ready) {
    ...
    if (getIntent() != null && getIntent().getCategories() != null && getIntent().getCategories().contains("android.intent.category.NOTIFICATION_PREFERENCES")) {
      ...
      initFragment(R.id.container, new ApplicationPreferenceFragment());//A++ id.container
    } else {
  ...
  public void pushFragment(@NonNull Fragment fragment) {
    getSupportFragmentManager().beginTransaction()
            ...
            .replace(R.id.container, fragment)//AA+ container
            .addToBackStack(null)
            .commit();
  }
...
//      this.findPreference(PREFERENCE_CATEGORY_SMS_MMS)//AA-
//        .setOnPreferenceClickListener(new CategoryClickListener(PREFERENCE_CATEGORY_SMS_MMS));
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
      ...
      if (SignalStore.paymentsValues().getPaymentsAvailability().showPaymentsMenu()) {
        ...
        unreadPaymentsLiveData.observe(getViewLifecycleOwner(), unreadPayments -> paymentsPreference.setUnreadCount(unreadPayments.transform(UnreadPayments::getUnreadCount).orElse(-1)));
      }
    }
    ...
    private void setCategoryVisibility() {
      ...
      if (true || devicePreference != null && !TextSecurePreferences.isPushRegistered(getActivity())) { //+AA removed pref
          if (devicePreference != null) getPreferenceScreen().removePreference(devicePreference);
        }
    }
...
//          .setSummary(SmsMmsPreferenceFragment.getSummary(getActivity()));
    ...
    private static boolean shouldDisplayUsernameReminder() {
      return !Recipient.self().getNicknameMaybe().isPresent();//AA+
