...
class RetrieveReleaseChannelJob private constructor(private val force: Boolean, parameters: Parameters) : BaseJob(parameters) {
  companion object {
    ...
    private const val MANIFEST = "https://unfacd.com/ufsrv/release-notes.json"
...
*/
  ...
  override fun onRun() {
   ...
   /* if (!force && System.currentTimeMillis() < values.nextScheduledCheck) {
    ...
    //AA-
    /*i if (values.previousManifestMd5.isEmpty() && (SignalDatabase.threads.getArchivedConversationListCount() + SignalDatabase.threads.getUnarchivedConversationListCount()) < 6) {
...
//        .filter { it.androidMinVersion!!.toIntOrNull()?.let { minVersion: Int -> minVersion > values.highestVersionNoteReceived && minVersion <= BuildConfig.CANONICAL_VERSION_CODE } ?: false } //AA-
  ...
  //AA using uuid value previously fetched
//  https://updates.signal.org/static/release-notes/cd59d6f6-48a4-49e6-a862-e92dff9c1e74/en.json
  //{"imageWidth":"1920","image":"/static/release-notes/gift-release-notes.png","uuid":"cd59d6f6-48a4-49e6-a862-e92dff9c1e74","imageHeight":"1080","body":"Now, you can gift a profile badge to a friend by donating to unfacd.\n\nYour friend can choose to display a UFO on their profile and you can check \"support private communications nonprofit\" off your to-do list.\n\nTap the button below to try it out or go to Settings >> Donate to unfacd >> Gift a Badge\n\nThank you for supporting unfacd! ","title":"Share your support","callToActionText":"Gift a Badge"}
