...
public class PushProcessMessageJob extends BaseJob {
    ...
    if (content != null) {
      ...
      if (signalServiceGroupContext != null) {
        try {
          ...
          if (groupId.isV2()) {
            int localRevision = SignalDatabase.groups()
      ...
      Recipient recipient = exceptionMetadata.getGroupId() != null ? Recipient.externalGroupExact(context, exceptionMetadata.getGroupId())//AA+ externalGroupExact
