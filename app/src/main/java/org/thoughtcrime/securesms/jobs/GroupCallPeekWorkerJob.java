...
final class GroupCallPeekWorkerJob extends BaseJob {
  ...
  protected void onRun() {
    ApplicationDependencies.getSignalCallManager().peekGroupCall(groupRecipientId); //.putExtra(WebRtcCallService.EXTRA_REMOTE_PEER, new RemotePeer(groupRecipientId, -1));//AA+ -1
  }
