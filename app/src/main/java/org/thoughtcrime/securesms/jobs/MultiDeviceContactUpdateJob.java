...
public class MultiDeviceContactUpdateJob extends BaseJob {
  ...
  @Override
  public void onRun()
          throws IOException, UntrustedIdentityException, NetworkException, InvalidKeyException
  {
  ...
  private void sendUpdate(SignalServiceMessageSender messageSender, InputStream stream, long length, boolean complete)
          throws UntrustedIdentityException, NetworkException, InvalidKeyException
  {
    if (length > 0) {
      try {
