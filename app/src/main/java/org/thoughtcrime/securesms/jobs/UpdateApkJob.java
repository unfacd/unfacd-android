...
public class UpdateApkJob extends BaseJob {
  ...
  private void handleDownloadStart(String uri, String versionName, byte[] digest) {
    ...
    downloadRequest.setTitle("Downloading unfacd update");//AA+
    downloadRequest.setDescription("Downloading unfacd " + versionName);
    downloadRequest.setVisibleInDownloadsUi(false);
    downloadRequest.setDestinationInExternalFilesDir(context, null, "unfacd-update.apk");
