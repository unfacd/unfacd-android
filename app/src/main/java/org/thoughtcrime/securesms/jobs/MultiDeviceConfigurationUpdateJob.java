...
public class MultiDeviceConfigurationUpdateJob extends BaseJob
{
  ...
  private MultiDeviceConfigurationUpdateJob (
          @NonNull Job.Parameters parameters,
          boolean readReceiptsEnabled,
          boolean typingIndicatorsEnabled,
          boolean unidentifiedDeliveryIndicatorsEnabled,
          boolean linkPreviewsEnabled)
  ...
  @Override
  public void onRun () throws IOException, UntrustedIdentityException, InvalidKeyException //AA+ invalid
  {
  ...
  {
    if (e instanceof ServerRejectedException) {
      return false;
    }
