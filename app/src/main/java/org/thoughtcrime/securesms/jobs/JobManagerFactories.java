...
//      put(UuidMigrationJob.KEY,                      new UuidMigrationJob.Factory());
      ...
      put(UfsrvProfileRetrieverJob.KEY,               new UfsrvProfileRetrieverJob.Factory());
      put(IntroMessageAvatarDownloadJob.KEY,          new IntroMessageAvatarDownloadJob.Factory());
      ...
      put(MessageReportedJob.KEY,                     new MessageReportedJob.Factory());
      put(GuardianRequestJob.KEY,                     new GuardianRequestJob.Factory());
      put(MessageEffectsJob.KEY,                      new MessageEffectsJob.Factory());
