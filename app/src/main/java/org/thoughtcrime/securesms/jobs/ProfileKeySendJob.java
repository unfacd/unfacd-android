...
public class ProfileKeySendJob extends BaseJob {
  ...
  private List<Recipient> deliver(@NonNull List<Recipient> destinations) throws IOException, UntrustedIdentityException, InvalidKeyException, EncapsulatedExceptions
  {
