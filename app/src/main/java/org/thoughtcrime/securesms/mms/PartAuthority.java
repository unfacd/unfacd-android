...
public class PartAuthority {
  ...
  static {
    ...
    uriMatcher.addURI(AUTHORITY, "part/*/*/#", PART_ROW);//AA+ keep two wild cards
...
//    Uri uri = Uri.withAppendedPath(PART_CONTENT_URI, String.valueOf(attachmentId.getUniqueId()));
    Uri uri = Uri.withAppendedPath(PART_CONTENT_URI, String.valueOf(attachmentId.getUniqueId()) + "/" + attachmentId.getUfId());//AA+
