...
public  static final String MIGRATE_DATABASE    = "com.unfacd.android.ApplicationMigration.MIGRATE_DATABSE";//AA+
  public  static final String COMPLETED_ACTION  = "com.unfacd.android.ApplicationMigrationService.COMPLETED";
  private static final String PREFERENCES_NAME  = "unfacdSMS";
  ...
  private void registerCompletedReceiver() {
    ...
    ContextCompat.registerReceiver(getApplicationContext(), completedReceiver, filter, ContextCompat.RECEIVER_NOT_EXPORTED);
  }
  ...
  private class ImportRunnable implements Runnable {
    ...
    public void run() {
      ...
      WakeLock     wakeLock     = powerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "unfacd:migration");//AA+
