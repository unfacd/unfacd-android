...
public class ApplicationDependencies {
  ...
  //AA+
  public static @NonNull SignalServiceAccountManager getSignalServiceAccountManager(boolean reload) {
    if (reload) {
      accountManager = provider.provideSignalServiceAccountManager();
    }
  ...
  public static @NonNull KeyBackupService getKeyBackupService(@NonNull KbsEnclave enclave) {
    return getSignalServiceAccountManager(true).getKeyBackupService(IasKeyStore.getIasKeyStore(application),//AA+ true
