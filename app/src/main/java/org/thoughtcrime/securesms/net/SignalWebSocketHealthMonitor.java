      ...
      while (shouldKeepRunning && isKeepAliveNecessary()) {
        try {
          ...
          if (shouldKeepRunning && isKeepAliveNecessary()) {
            ...
            if (identified.lastKeepAliveReceived < keepAliveRequiredSinceTime /*|| unidentified.lastKeepAliveReceived < keepAliveRequiredSinceTime*/) {//AA- triggers websocket disconnection, as we don't utilise unidentified
