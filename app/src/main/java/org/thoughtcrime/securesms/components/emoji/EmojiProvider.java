...
public class EmojiProvider {
   ...
   */
  public static @Nullable Drawable getEmojiDrawable(@NonNull Context context, @Nullable EmojiDrawInfo drawInfo, @Nullable Runnable onEmojiLoaded, boolean jumboEmoji) {//AA+ public
    if (drawInfo == null) {
      return null;
    }
  ...
  //AA+
  public static boolean isAllEmojiText(CharSequence text)
  {
    EmojiParser.CandidateList candidates = new EmojiParser(EmojiSource.getLatest().getEmojiTree()).findCandidates(text);
    return candidates.allEmojis;
  }
  //
