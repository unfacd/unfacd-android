...
public class ConversationItemFooter extends ConstraintLayout {
  ...
  private ImageView                   reportedMsgIndicatorView;//AA+
  ...
  private void init(@Nullable AttributeSet attrs) {
    ...
    reportedMsgIndicatorView    = findViewById(R.id.footer_reported_msg); //AA+
  ...
  public void setMessageRecord(@NonNull MessageRecord messageRecord, @NonNull Locale locale) {
    ...
    presentReportedIndicator(messageRecord); //AA+
  ...
  //AA+
  private void presentReportedIndicator(@NonNull MessageRecord messageRecord)
  {
    if (messageRecord.getUfsrtvStatus() == 1) {
      reportedMsgIndicatorView.setVisibility(View.VISIBLE);
      Animation animation1 = AnimationUtils.loadAnimation(getContext(), R.anim.blink);
      reportedMsgIndicatorView.startAnimation(animation1);
    }
    else {
      reportedMsgIndicatorView.setVisibility(View.GONE);
    }
  }
