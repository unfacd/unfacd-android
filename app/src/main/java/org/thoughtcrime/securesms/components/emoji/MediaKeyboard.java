...
public class MediaKeyboard extends FrameLayout implements InputView {
  ...
  private void initView() {
    if (!isInitialised) {
      ...
      //AA+ to enable working with DialogFragment
//      FragmentActivity fragmentActivity;
//      try {
//        fragmentActivity = FragmentManager.findFragment(this).getActivity();
...
//      }
      ...
      isInitialised         = true;
//      fragmentManager       = fragmentActivity.getSupportFragmentManager();//AA+ to enable working with DialogFragment
    }
  }
