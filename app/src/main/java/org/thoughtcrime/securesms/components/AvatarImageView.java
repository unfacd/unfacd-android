...
public final class AvatarImageView extends AvatarWithIndicators {//AppCompatImageView { //AA+
  ...
  @Override
  public void onDraw(Canvas canvas) {//AA+ public
    super.onDraw(canvas);
      ...
      if (!photo.equals(recipientContactPhoto) || shouldBlur != blurred || !Objects.equals(chatColors, this.chatColors)) {
        ...
        if (photo.contactPhoto != null) {
          ...
          GlideRequest<Drawable> request = requestManager.load(photo.contactPhoto)
                                                         ...
                                                         //              .signature(new ObjectKey(UfsrvFenceUtils.isAvatarUfsrvIdLoaded(recipient.getGroupAvatarUfsrvId())?recipient.getGroupAvatarUfsrvId():""))//AA+
