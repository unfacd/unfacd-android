...
//          Tasks.await(FirebaseInstallations.getInstance().delete())//AA-

          //AA+
          FirebaseMessaging.getInstance().deleteToken().addOnCompleteListener { task: Task<Void?>? -> Log.d(TAG, "Token Deleted!!!") }
          FirebaseInstallations.getInstance().delete().addOnCompleteListener { task: Task<Void?>? -> Log.d(TAG, "Token Deleted!!!") }
        }
