...
public class WebRtcCallViewModel extends ViewModel {
  ...
  private final MutableLiveData<Long> groupFid = new MutableLiveData<>(Long.valueOf(-1));//AA+
  ...
  //AA+
  @MainThread
  public void setGroupFid(@NonNull Long groupFidProvided) {
    groupFid.setValue(groupFidProvided);
  }

  public Long getGroupFid() {
    return groupRecipient.getValue().getUfsrvId();
  }
  //
