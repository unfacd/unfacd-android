...
public class MessageRequestsBottomView extends ConstraintLayout {
  ...
  protected void onFinishInflate() {
    ...
    linJoinGroup   = findViewById(R.id.message_request_linkjoin_buttons);//AA+
  }
  ...
  public void setMessageData(@NonNull MessageRequestViewModel.MessageData messageData) {
    ...
    switch (messageData.getMessageState()) {
      ...
      case GROUP_LINK_JOIN_AUTHORIZATION://AA+
        question.setText(getContext().getString(R.string.MessageRequestBottomView_group_link_join_authorisation_required));
        setActiveInactiveGroups(linJoinGroup, blockedButtons);
        accept.setText(R.string.MessageRequestBottomView_withdraw);
        break;
    }
  }
