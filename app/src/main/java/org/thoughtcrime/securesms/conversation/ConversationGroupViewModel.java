...
//  private final LiveData<List<RecipientId>>         gv1MigrationSuggestions;
  ...
  //AA+
  private MutableLiveData<AdminAction> adminAction = new MutableLiveData<>();
...
//    return groupManagementRepository.blockJoinRequests(groupRecipient.requireGroupId().requireV2(), recipient)//AA-
//                                    .observeOn(AndroidSchedulers.mainThread());
    launchManagePendingAndRequestingMembersActivity();
    return null;
  }

  //AA+
  public LiveData<AdminAction> getAdminAction() {
    return adminAction;
  }

  private void launchManagePendingAndRequestingMembersActivity() {
    adminAction.setValue(new AdminAction(AdminAction.SHOW_REQUESTS));
  }
//
  ...
  //AA++ facilitate the opening of ManagePendingAndRequestingMembersActivity
  public class AdminAction {
    public static final int SHOW_REQUESTS = 0;
//    public static final int SHOW_xx = 1;

    private final int adminAction;

    public AdminAction(int adminAction) {
