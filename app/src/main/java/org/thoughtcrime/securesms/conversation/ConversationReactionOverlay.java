...
public final class ConversationReactionOverlay extends FrameLayout {
  ...
  private @NonNull List<ActionItem> getMenuActionItems(@NonNull ConversationMessage conversationMessage) {
    ...
    if (menuState.shouldShowReportAction()) {//AA+
      items.add(new ActionItem(R.drawable.front_hand_24_tinted, getResources().getString(R.string.conversation_selection__menu_report_message), () -> handleActionItemClicked(Action.FORWARD)));
    }
