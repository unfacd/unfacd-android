...
object ChatColorsPalette {
  object Bubbles {
    ...
    @JvmField
    val ORANGE = ChatColors.forColor(//AA+
            ChatColors.Id.BuiltIn, 0xff8833.toInt()
    )

    @JvmField
    val GREY = ChatColors.forColor(//AA+ GREY_400
            ChatColors.Id.BuiltIn, 0xBDBDBD.toInt()
    )
...
//      ORANGE, GREY
  ...
  @JvmField
  val UNKNOWN_CONTACT = Bubbles.ORANGE//AA+
}
