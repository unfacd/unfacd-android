...
public class PhoneNumberFormatter {
  ...
  //AA+ not exactly true semantics but will do for now to enable quick qualification...
  public static boolean isLikelyE164Number(String number) {
    if (number.startsWith("+") || number.length() <= 16)  return true;
    return false;
  }
