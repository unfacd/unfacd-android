...
public class TextSecurePreferences {
  ...
  private static final String GUARDIAN_ENCRYPTED_SECRET     = "pref_guardian_encrypted_secret";
  private static final String GUARDIAN_UFSRVUID     = "pref_guardian_ufsrvuid";

  //also check added UFSRV_ACCESS_TOKEN below
  ...
  //AA+
  public  static final String UFSRV_COOKIE                      = "pref_ufsrv_cookie";
  public  static final String UFSRV_PENDING_COOKIE              = "pref_ufsrv_pending_cookie";
  public  static final String UFSRV_USERNAME                      = "pref_ufsrv_username";
  public static final String UFSRV_SERVERID                     = "pref_ufsrv_serverid";
  public static final String UFSRV_CID                          = "pref_ufsrv_cid";
  public static final String UFSRV_USERID                       = "pref_userid";
  public static final String UFSRV_UFSRVUID                     = "pref_ufsrvuid";
  public static final String UFSRV_NICKNAME                     = "pref_ufsrv_nickname";
  public static final String UFSRV_ACCOUNT_CREATED              = "pref_ufsrv_UF_account_created";
  public static final String UFSRV_SEEN_INTRO                   = "pref_ufsrv_seen_intro";

  public static final String UFSRV_UNSOLICITED_CONTACT_ACTION   = "pref_unsolicited_contact_action";
  public static final String UFSRV_GEOGROUPS_ROAMING            = "pref_geogroups_roaming";
  public static final String UFSRV_GEOGROUPS_ROAMING_MODE       = "pref_geogroups_roaming_mode";
  public static final String UFSRV_GEOGROUPS_LOCALITY_LEVEL     = "pref_geogroups_locality_level";
  public static final String UFSRV_GEOGROUPS_BASELOC_LEVEL      = "pref_usergroups_baseloc_level";
  public static final String UFSRV_TOOLTIP_0                    = "pref_tooltip_0";
  public static final String UFSRV_TOOLTIP_1                    = "pref_tooltip_1";
  public static final String UFSRV_LAST_SELECTED_PAGER          = "pref_last_selected_pager";
  public static final String UFSRV_TOOLTIP_TEMPLATE             = "pref_tooltip_";
  public static final String UFSRV_FENCEMAP_LAST_POSITION_LONG  = "pref_fence_map_last_position_lang";
  public static final String UFSRV_FENCEMAP_LAST_POSITION_LAT   = "pref_fence_map_last_position_lat";
  private static final String UFSRV_SHARE_PROFILE_REMIDER_MSG   = "pref_share_profile_reminder_msg";
  private static final String PRESENCE_RECEIVE_TIME_PREF        = "pref_presence_receive_time";
  private static final String UFSRV_ACCESS_TOKEN                = "pref_ufsrv_access_token";
  ...
  //AA+
  public static void setTooltipWithIdx (Context context, int idx, boolean enabled)
  {
    setBooleanPreference(context, UFSRV_TOOLTIP_TEMPLATE+idx, enabled);
  }

  public static boolean getTooltipWithIdx (Context context, int idx)
  {
    return getBooleanPreference(context, UFSRV_TOOLTIP_TEMPLATE+idx, true);
  }

  public static int getLastSelectedPager(Context context) {
    return getIntegerPreference(context, UFSRV_LAST_SELECTED_PAGER, 0);
  }

  public static void setLastSelectedPager(Context context, int pageIdx) {
    setIntegerPrefrence(context, UFSRV_LAST_SELECTED_PAGER, pageIdx);
  }

  public static void  setFenceMapLastPositionLong (Context context, float longitude)
  {
    setFloatPreference(context, UFSRV_FENCEMAP_LAST_POSITION_LONG, longitude);
  }

  public static float  getFenceMapLastPositionLong (Context context)
  {
    ufLocation myLocation = ufLocation.getInstance();
    return getFloatPreference(context, UFSRV_FENCEMAP_LAST_POSITION_LONG, (float)myLocation.getMyLocation().getLongitude());
  }

  public static void  setFenceMapLastPositionLat (Context context, float latitude)
  {
    setFloatPreference(context, UFSRV_FENCEMAP_LAST_POSITION_LAT, latitude);
  }

  public static float  getFenceMapLastPositionLat (Context context)
  {
    ufLocation myLocation = ufLocation.getInstance();
    return getFloatPreference(context, UFSRV_FENCEMAP_LAST_POSITION_LAT, (float)myLocation.getMyLocation().getLatitude());
  }

  public static @Nullable String getAccessToken(Context context) {
    return getStringPreference(context, UFSRV_ACCESS_TOKEN, null);
  }

  public static void setAccessToken(Context context, String accessToken) {
    setStringPreference(context, UFSRV_ACCESS_TOKEN, accessToken);
  }
  //
...
//    return getBooleanPreference(context, SEEN_WELCOME_SCREEN_PREF, true);
  ...
  //AA+
  public static void setUfsrvNickname (Context context, String nickname)
  {
    setStringPreference(context, UFSRV_NICKNAME, nickname);
  }

  public static String getUfsrvNickname (Context context)
  {
    return (getStringPreference(context, UFSRV_NICKNAME, ""));
  }

  public static void setUserId(Context context, long userid)
  {
    setLongPreference(context, UFSRV_USERID, userid);
  }

  public static Long getUserId(Context context)
  {
    return (getLongPreference(context, UFSRV_USERID, 0));
  }

  public static void setUfsrvUserId(Context context, String userid)
  {
    setStringPreference(context, UFSRV_UFSRVUID, userid);
  }

  public static String getUfsrvUserId(Context context)
  {
    return (getStringPreference(context, UFSRV_UFSRVUID, UfsrvUid.UndefinedUfsrvUid));
  }

  public static void setUfsrvGeoGroupRoamingMode(Context context, int roamingMode)
  {
    setIntegerPrefrence(context, UFSRV_GEOGROUPS_ROAMING_MODE, roamingMode);
  }

  public static int getUfsrvGeoGroupRoamingMode(Context context)
  {
    return (getIntegerPreference(context, UFSRV_GEOGROUPS_ROAMING_MODE, UserPrefsUtils.RoamingMode.RM_WANDERER.getValue()));
  }

  public static void setUnsolicitedContactAction(Context context, String contactAction)
  {
    setStringPreference(context, UFSRV_UNSOLICITED_CONTACT_ACTION, contactAction);
  }

  public static String getUnsolicitedContactAction(Context context)
  {
    return (getStringPreference(context, UFSRV_UNSOLICITED_CONTACT_ACTION, "0"));
  }

  public static void setUfsrvServerId(Context context, String serverId)
  {
    setStringPreference(context, UFSRV_SERVERID, serverId);
  }

  public static String getUfsrvServerId(Context context)
  {
    return (getStringPreference(context, UFSRV_SERVERID, ""));
  }

  public static void setUfsrvCid(Context context, String serverId)
  {
    setStringPreference(context, UFSRV_CID, serverId);
  }

  public static String getUfsrvCid(Context context)
  {
    return (getStringPreference(context, UFSRV_CID, ""));
  }

  public static void setUfsrvCookie(Context context, String cookie)
  {
    setStringPreference(context, UFSRV_COOKIE, cookie);
  }

  public static String  getUfsrvCookie(Context context)
  {
    return (getStringPreference(context, UFSRV_COOKIE, null));
  }

  public static void setUfsrvPendingCookie(Context context, String cookie)
  {
    setStringPreference(context, UFSRV_PENDING_COOKIE, cookie);
  }

  public static String  getUfsrvPendingCookie(Context context)
  {
    return (getStringPreference(context, UFSRV_PENDING_COOKIE, null));
  }

  public static void setUfsrvUsername(Context context, String cookie)
  {
    setStringPreference(context, UFSRV_USERNAME, cookie);
  }

  public static String  getUfsrvUsername(Context context)
  {
    return (getStringPreference(context, UFSRV_USERNAME, null));
  }

  public static void setUfsrvUfAccountCreated(Context context, boolean value) {
    setBooleanPreference(context, UFSRV_ACCOUNT_CREATED, value);
  }

  public static boolean getUfsrvUfAccountCreated(Context context) {
    return (getBooleanPreference(context, UFSRV_ACCOUNT_CREATED, false));
  }

  public static void setProfileShareReminder(Context context, boolean value) {
    setBooleanPreference(context, UFSRV_SHARE_PROFILE_REMIDER_MSG, value);
  }

  public static boolean getProfileShareReminder(Context context) {
    return (getBooleanPreference(context, UFSRV_SHARE_PROFILE_REMIDER_MSG, true));
  }
//
  ...
  public static long getPresenceReceiveTime(Context context) {
    return getLongPreference(context, PRESENCE_RECEIVE_TIME_PREF, 0L);
  }

  public static void setPresenceReceiveTime(Context context, long value) {
    setLongPreference(context, PRESENCE_RECEIVE_TIME_PREF, value);
  }

  public static long getRegoStatusCheckerTime(Context context) {
    return getLongPreference(context, "pref_rego_status_checker_time", 0L);
  }

  public static void setRegoStatusCheckerTime(Context context, long value) {
    setLongPreference(context, "pref_rego_status_checker_time", value);
  }

  public static @Nullable String getGuardianEncryptedSecret(@NonNull Context context) {
    return getStringPreference(context, GUARDIAN_ENCRYPTED_SECRET, null);
  }

  public static void setGuardianeEncryptedSecret(@NonNull Context context, @NonNull String secret) {
    setStringPreference(context, GUARDIAN_ENCRYPTED_SECRET, secret);
  }

  public static @Nullable String getGuardian(@NonNull Context context) {
    return getStringPreference(context, GUARDIAN_UFSRVUID, null);
  }

  public static void setGuardian(@NonNull Context context, @NonNull String ufsrvUid) {
    setStringPreference(context, GUARDIAN_UFSRVUID, ufsrvUid);
  }
  //
