...
public final class SignalProxyUtil {
  ...
  private static final String PROXY_LINK_HOST = "unfacd.io";//AA+

  private static final Pattern PROXY_LINK_PATTERN = Pattern.compile("^(https|unfcd)://" + PROXY_LINK_HOST + "/#([^:]+).*$");//AA+
