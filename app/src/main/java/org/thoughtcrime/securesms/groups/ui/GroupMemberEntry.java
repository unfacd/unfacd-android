...
//      if (cancellable && inviteeCipherText == null) {//AA- we don't generate cipherText
...
//      }
  ...
  public final static class UnknownPendingMemberCount extends GroupMemberEntry {
    ...
    private final Collection<Recipient> recipients;//AA+
    private final boolean                    cancellable;

    public UnknownPendingMemberCount(@NonNull Recipient inviter,
                                     @NonNull Collection<UuidCiphertext> ciphertexts,
                                     @NonNull Collection<Recipient> recipients,//AA+
                                     boolean cancellable) {
      this.inviter     = inviter;
      this.ciphertexts = ciphertexts;
      this.cancellable = cancellable;
      this.recipients  = recipients;//AA+
    }
    ...
    public boolean equals(@Nullable Object obj) {
      ...
      return other.inviter.equals(inviter) &&
              ...
              other.recipients.equals(recipients) &&//AA+
              other.cancellable == cancellable;
    }
