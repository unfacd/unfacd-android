...
public class PendingMemberInvitesFragment extends Fragment {
  ...
  public static PendingMemberInvitesFragment newInstance(@NonNull GroupId groupId) {
  ...
  public void onActivityCreated(@Nullable Bundle savedInstanceState) {
    ...
    GroupId groupId = GroupId.parseOrThrow(Objects.requireNonNull(requireArguments().getString(GROUP_ID)));
