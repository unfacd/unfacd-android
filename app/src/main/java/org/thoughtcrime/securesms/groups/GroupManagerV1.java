...
final class GroupManagerV1 {
  ...
  //TBD V1
  static @NonNull GroupManager.GroupActionResult createGroup(@NonNull Context          context,
...
//    groupDatabase.updateMembers(groupId, new LinkedList<>(memberAddresses));//AA-
...
//        uuidMembers.add(GroupV1MessageProcessor.createMember(RecipientUtil.toSignalServiceAddress(context, recipient)));
    ...
    OutgoingGroupUpdateMessage outgoingMessage = new OutgoingGroupUpdateMessage(groupRecipient, groupContext, avatarAttachment, System.currentTimeMillis(), 0, false, null, Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), null);
    long                      threadId        = MessageSender.send(context, outgoingMessage, -1, false, null, null, UfsrvCommand.TransportType.UNDEFINED, false);
  ...
  static void updateGroupTimer(@NonNull Context context, @NonNull GroupId.V1 groupId, int expirationTime) {
    ...
    OutgoingExpirationUpdateMessage outgoingMessage = new OutgoingExpirationUpdateMessage(recipient, System.currentTimeMillis(), expirationTime * 1000L, (String)null);//AA+
    MessageSender.send(context, outgoingMessage, threadId, false, null, null, UfsrvCommand.TransportType.UNDEFINED, false);//AA+
  }
