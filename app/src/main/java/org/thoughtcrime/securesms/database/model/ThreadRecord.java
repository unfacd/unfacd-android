...
public final class ThreadRecord {
  ...
  //AA+
  private final long       ufsrvEid;
  private final long       ufsrvGid;
  private final long       ufsrvFid;
  private final int        ufsrtvStatus;
  private final int        ufsrvCommandType;
  private final int        ufsrvCommandArg;
  private final UfsrvCommandWire ufsrvCommand;
  ...
  private ThreadRecord(@NonNull Builder builder) {
    ...
    this.ufsrvEid             = builder.ufsrvEid;
    this.ufsrvGid             = builder.ufsrvGid;
    this.ufsrvFid             = builder.ufsrvFid;
    this.ufsrtvStatus         = builder.ufsrtvStatus;
    this.ufsrvCommandType     = builder.ufsrvCommandType;
    this.ufsrvCommandArg      = builder.ufsrvCommandArg;
    this.ufsrvCommand         = builder.ufsrvCommand;
  }
  ...
  //AA+
  public long getUfsrvEid()
  {
    return ufsrvEid;
  }

  public long getUfsrvFid()
  {
    return ufsrvFid;
  }

  public long getUfsrvGid()
  {
    return ufsrvGid;
  }

  public int getUfsrtvStatus()
  {
    return ufsrtvStatus;
  }

  public int getUfsrvCommandType()
  {
    return ufsrvCommandType;
  }

  public int getUfsrvCommandArg()
  {
    return ufsrvCommandArg;
  }
...
//
  ...
  public static class Builder {
    ...
    //AA+
    private long       ufsrvEid;
    private long       ufsrvGid;
    private long       ufsrvFid;
    private int        ufsrtvStatus;
    private int        ufsrvCommandType;
    private int        ufsrvCommandArg;
    private UfsrvCommandWire ufsrvCommand;
    ...
    //AA+
    public Builder setUfsrvEid(long ufsrvEid) {
      this.ufsrvEid = ufsrvEid;
      return this;
    }

    public Builder setUfsrvFid(long ufsrvFid) {
      this.ufsrvFid = ufsrvFid;
      return this;
    }

    public Builder setUfsrvCommand(UfsrvCommandWire ufsrvCommand) {
      this.ufsrvCommand = ufsrvCommand;
      return this;
    }

    public Builder setUfsrvCommandAr(int ufsrvCommandArg) {
      this.ufsrvCommandArg = ufsrvCommandArg;
      return this;
    }

    public Builder setUfsrtvStatus(int ufsrtvStatus) {
      this.ufsrtvStatus = ufsrtvStatus;
      return this;
    }

    public Builder setUfsrvCommandType(int ufsrvCommandType) {
      this.ufsrvCommandType = ufsrvCommandType;
      return this;
    }

    public Builder setUfsrvGid(long ufsrvGid) {
      this.ufsrvGid = ufsrvGid;
      return this;
    }
//
