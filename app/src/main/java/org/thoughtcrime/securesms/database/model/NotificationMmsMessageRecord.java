...
public class NotificationMmsMessageRecord extends MmsMessageRecord {
  ...
  public NotificationMmsMessageRecord(long id, Recipient conversationRecipient,
                                      ...
                                      SignalServiceProtos.UfsrvCommandWire ufsrvCommand, long eid)//AA+  ufsrvcomand
  {
  ...
  public SpannableString getDisplayBody(@NonNull Context context) {
   if (status == MmsDatabase.Status.DOWNLOAD_INITIALIZED) {
       return new SpannableString(context.getString(R.string.NotificationMmsMessageRecord_multimedia_message));
     } else if (status == MmsDatabase.Status.DOWNLOAD_CONNECTING) {
       return new SpannableString(context.getString(R.string.NotificationMmsMessageRecord_downloading_mms_message));
     } else {
       return new SpannableString(context.getString(R.string.NotificationMmsMessageRecord_error_downloading_mms_message));
     }
  }
}
