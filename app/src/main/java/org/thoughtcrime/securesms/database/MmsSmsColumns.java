...
public interface MmsSmsColumns {
  ...
  //AA+ temporary encapsulation
  public static final String UFSRV_COMMAND = "ufsrv_command";
  public static final String UFSRV_EID = "ufsrv_eid";
  public static final String UFSRV_GID = "ufsrv_gid";
  public static final String UFSRV_STATUS = "ufsrv_status";
  public static final String UFSRV_CMD_TYPE = "ufsrv_cmd_type";
  public static final String UFSRV_CMD_ARG = "ufsrv_cmd_arg";
  ...
  public static class Types {
    ...
    //AA+
    protected static final long PROFILE_TYPE                       = 64;
    protected static final long GROUP_PROFILE_TYPE                  = 63;
    protected static final long REPORTED_MSG_TYPE                  = 62;
    protected static final long GUARDIAN_TYPE                       = 61;
...
//    protected static final long ENCRYPTION_ASYMMETRIC_BIT        = 0x40000000;
    ...
    //AA+
    public static boolean isProfileLog(long type) {
      return type == PROFILE_TYPE;
    }

    public static boolean isGroupProfileLog(long type) {
      return type == GROUP_PROFILE_TYPE;
    }

    public static boolean isReportedMessageLog(long type) {
      return type == REPORTED_MSG_TYPE;
    }

    public static boolean isGuardianLog(long type) {
    ...
    public static boolean isGroupQuit(long type) {
      return (type & GROUP_LEAVE_BIT) != 0 /*&& (type & GROUP_V2_BIT) == 0*/;//AA-
    }
