...
public abstract class DisplayRecord {
  ...
  public DisplayRecord(String body, Recipient recipient, long dateSent,
                       long dateReceived, long threadId, int deliveryStatus, int deliveryReceiptCount,
                       long type, int readReceiptCount, int viewReceiptCount,
                       SignalServiceProtos.UfsrvCommandWire ufsrvCommand, long gid, long eid, long fid, int status, int commandType, int commandArg)
  {
    ...
    this.ufsrvEid             = eid;
    this.ufsrvFid             = fid;
    this.ufsrtvStatus         = status;
    this.ufsrvCommandType     = commandType;
    this.ufsrvCommandArg      = commandArg;
  }

  //AA+
  public boolean isProfileLog () {
    return SmsDatabase.Types.isProfileLog(type);
  }

  public boolean isGroupProfileLog () {
    return SmsDatabase.Types.isGroupProfileLog(type);
  }
  //

  public boolean isReportedMessageLog () {
    return SmsDatabase.Types.isReportedMessageLog(type);
  }

  public boolean isGuardianLog () {
    return SmsDatabase.Types.isGuardianLog(type);
  }
