...
public abstract class MessageDatabase extends Database implements MmsSmsColumns {
  ...
  public abstract @NonNull Pair<Long, Long> insertReceivedCall(long fid, @NonNull RecipientId address, boolean isVideoOffer);//AA+ fid
  public abstract @NonNull Pair<Long, Long> insertOutgoingCall(long fid, @NonNull RecipientId address, boolean isVideoOffer);//
  public abstract @NonNull Pair<Long, Long> insertMissedCall(long fid, @NonNull RecipientId address, long timestamp, boolean isVideoOffer);//
  ...
  //AA+
  public abstract void markUfsrvStatus(long messageId, int status);
  public abstract @NonNull Pair<Long, Long> insertMessageReportedTypeLog(SmsMessageRecord messageRecord, long threadId, boolean unread);
  public abstract @NonNull Pair<Long, Long> insertGuardianTypeLog(SmsMessageRecord messageRecord, long threadId, boolean unread);
  public abstract @NonNull Pair<Long, Long> insertProfileLog(long fid, @NonNull RecipientId recipientId, long timestamp, String encodedUfsrvMsg, boolean unread);
  public abstract @NonNull Pair<Long, Long> insertGroupProfileLog(long fid, @NonNull RecipientId recipientId, long timestamp, String encodedUfsrvMsg, boolean unread);
  public abstract @NonNull Pair<Long, Long> updateMessageIdentifiersForUfsrv(long timestamp, long ufsrvGid, long ufsrvEid);
  public abstract Pair<Long, Long> updateMessageUfsrvCommand(long messageId, String ufsrvCommand);
  public abstract @NonNull MmsDatabase.Reader getMessageByTimestamp(long timestamp, boolean received);
  public abstract @NonNull MmsDatabase.Reader getGroupUpdateMessages();
  public abstract int getUnreadThreadsCount();
 ...
 /* public void addReaction(long messageId, @NonNull ReactionRecord reaction) {
    ...
    try {
      ReactionList reactions   = getReactions(db, messageId).orElse(ReactionList.getDefaultInstance());
...
*/
 ...
 /* protected static List<ReactionRecord> parseReactions(@NonNull Cursor cursor) {
  ...
  public static class SyncMessageId {
    ...
    //AA+
    private String ufsrvuid; //should map to address
    private long fid;
    private long eid;
    private long gid;
    //
    ...
    //AA+
    public SyncMessageId(@NonNull RecipientId recipientId, long timetamp, String ufsrvuid, long fid, long gid, long eid) {
      this.recipientId  = recipientId;
      this.timetamp     = timetamp;
    ...
    public UfsrvMessageUtils.UfsrvMessageIdentifier getUfsrvMessageIdentifier() {
      return new UfsrvMessageUtils.UfsrvMessageIdentifier(ufsrvuid, gid, fid, eid, timetamp);
    }
    //
