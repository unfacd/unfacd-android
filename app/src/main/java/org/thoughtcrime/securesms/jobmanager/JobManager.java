...
public class JobManager implements ConstraintObserver.Notifier {
  ...
  public JobManager(@NonNull Application application, @NonNull Configuration configuration) {
    ...
    this.executor      = ThreadUtil.trace(new FilteredExecutor(configuration.getExecutorFactory().newSingleThreadExecutor("unfacd-JobManager"), ThreadUtil::isMainThread));//AA+
