...
public class FcmReceiveService extends FirebaseMessagingService {
  ...
  public void onMessageReceived(RemoteMessage remoteMessage) {
    ...
    if (registrationChallenge != null) {
      handleRegistrationPushChallenge(registrationChallenge);//AA for ufsrv this the rego email
  ...
  private static void handleReceivedNotification(Context context) {
    try {
      ...
      Log.w(TAG, "Failed to start service. Falling back to legacy approach." + e.getMessage());
