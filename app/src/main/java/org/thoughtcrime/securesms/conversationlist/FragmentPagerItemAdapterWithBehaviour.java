...
//AA+ copied from com.ogaclejapan.smarttablayout.utils.v4.FragmentPagerItemAdapter
public class FragmentPagerItemAdapterWithBehaviour extends FragmentPagerAdapter {

  private final FragmentPagerItems pages;
  private final SparseArrayCompat<WeakReference<Fragment>> holder;

  public FragmentPagerItemAdapterWithBehaviour (FragmentManager fm, FragmentPagerItems pages) {
