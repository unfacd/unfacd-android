...
public class SignalServiceAddress {
  ...
  private final Optional<String> e164;//AA used by uf for ufsrvuid
  ...
  public SignalServiceAddress(ServiceId serviceId, Optional<String> e164) {
    this.serviceId = serviceId;//Preconditions.checkNotNull(uuid);//AA-
    this.e164  = e164;
  }
  ...
  public static boolean isValidAddress(String rawUuid, String e164) {
    //return UuidUtil.parseOrNull(rawUuid) != null; //AA- as per https://github.com/signalapp/Signal-Android/commit/b21abb8e7e757c568bbf5e7e1e7e719f05e49a80
