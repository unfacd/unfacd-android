...
public class SharedContact {
  ...
  private final Optional<UfsrvUid>            ufsrvUid; //AA+
  ...
  //AA+
  public Optional<UfsrvUid> getUfsrvUid() {
    return ufsrvUid;
  }
  ...
  public static class Builder {
    ...
    //AA+
    public Builder withUfsrvUid(UfsrvUid ufsrvUid) {
      this.ufsrvUid = ufsrvUid;
      return this;
    }
    ...
    public SharedContact build() {
      return new SharedContact(name, Optional.ofNullable(avatar),
                               phone.isEmpty()   ? Optional.<List<Phone>>empty() : Optional.of(phone),
                               email.isEmpty()   ? Optional.<List<Email>>empty() : Optional.of(email),
                               address.isEmpty() ? Optional.<List<PostalAddress>>empty() : Optional.of(address),
                               Optional.ofNullable(organization),
                               Optional.ofNullable(ufsrvUid)); //AA+
    }
  }
}