...
public final class HashedPin {
  ...
  private final byte[] K;//AA 1st 32 bytes of the aragon hashed pin
  private final byte[] kbsAccessKey;//AA 2nd 32 bytes of the aragon hashed pin
  ...
  //AA+
  public String hexSerialised()
  {
    return Utils.hexSerialise(Bytes.concat(K, kbsAccessKey));
  }

  public byte[] whole()
  {
    return Bytes.concat(K, kbsAccessKey);
  }
  //
}