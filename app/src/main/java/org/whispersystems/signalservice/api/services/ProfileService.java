...
//    builder.addHeaders(AcceptLanguagesUtil.getAcceptLanguageHeader(locale));//AA-
    List<String> xHeaders = new LinkedList(){{add(AcceptLanguagesUtil.getAcceptLanguageHeader(locale));}};//AA+
    ...
    return signalWebSocket.request(requestMessage, unidentifiedAccess, Optional.of(xHeaders))//AA+ headers
