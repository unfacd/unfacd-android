...
public class AvatarWithIndicators extends AppCompatImageView
{
  ...
  static final private Map<EnumAvatarIndicators, Pair<ArrayList<Integer>, Integer>> drawableResources;
    ...
    Map<EnumAvatarIndicators, Pair<ArrayList<Integer>, Integer>> drawablesResourcesMap = new HashMap<>();
      ...
      drawablesResourcesMap.put(TOP_RIGHT, new Pair<>(topRightResources, R.color.core_ultramarine_dark));
      drawablesResourcesMap.put(MIDDLE_RIGHT, new Pair<>(middleRightResources, R.color.core_ultramarine_dark));
      drawablesResourcesMap.put(BOTTOM_RIGHT, new Pair<>(bottomRightResources, R.color.core_ultramarine_dark));
      drawablesResourcesMap.put(CENTRE_BOTTOM,new Pair<>(centreBottomResources, R.color.core_ultramarine_dark));
      drawablesResourcesMap.put(BOTTOM_LEFT, new Pair<>(botomLeftResources, R.color.core_ultramarine_dark));
      drawablesResourcesMap.put(MIDDLE_LEFT, new Pair<>(middleLeftResources, R.color.core_ultramarine_dark));
      drawablesResourcesMap.put(TOP_LEFT,   new Pair<>(topLeftResources, R.color.core_ultramarine_dark));
      drawablesResourcesMap.put(CENTRE_TOP, new Pair<>(centretTopResources, R.color.core_ultramarine_dark));
