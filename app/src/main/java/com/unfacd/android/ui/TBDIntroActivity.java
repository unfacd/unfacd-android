...
public class TBDIntroActivity extends BaseActivity
{
  ...
  private void onContinue() {
    Permissions.with(this)
               ...
               .ifNecessary()
               .withRationaleDialog(Html.fromHtml(getString(R.string.RegistrationActivity_signal_needs_access_to_your_contacts_and_media_in_order_to_connect_with_friends)).toString(),
