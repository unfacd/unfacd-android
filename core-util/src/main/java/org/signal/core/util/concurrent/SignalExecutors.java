...
public final class SignalExecutors {
  ...
  public static final ExecutorService UNBOUNDED  = ThreadUtil.trace(Executors.newCachedThreadPool(new NumberedThreadFactory("unfacd-unbounded")));//AA+
  public static final ExecutorService BOUNDED    = ThreadUtil.trace(Executors.newFixedThreadPool(4, new NumberedThreadFactory("unfacd-bounded")));
  public static final ExecutorService SERIAL     = ThreadUtil.trace(Executors.newSingleThreadExecutor(new NumberedThreadFactory("unfacd-serial")));
  public static final ExecutorService BOUNDED_IO = ThreadUtil.trace(newCachedBoundedExecutor("unfacd-io-bounded", 1, 32, 30));
